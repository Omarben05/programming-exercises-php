...
<div class="row justify-content-center">
    <div class="col-md-8 col-lg-6">
        <div class="card p-4 mt-4 text-center">
            ...
            <div class="mb-3">
                <img src="{{ $flag }}" alt="Bandiera di {{ $country->name }}" style="width:100px; height:auto; border:1px solid #ccc;">
            </div>
            <h3 class="mb-3">
                @if(isset($timeout) && $timeout)
                    <span class="text-danger"><i class="bi bi-hourglass-split"></i> Tempo scaduto!</span>
                @elseif($isCorrect)
            ...
            <div class="mb-3">
                <strong>La capitale di {{ $country->name }} è: <span class="badge bg-info text-dark">{{ $correct }}</span></strong>
            </div>

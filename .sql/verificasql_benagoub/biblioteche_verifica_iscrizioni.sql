...
CREATE TABLE `iscrizioni` (
  ...
  CONSTRAINT `iscrizioni_ibfk_1` FOREIGN KEY (`codice_utente`) REFERENCES `utenti` (`codice`) ON DELETE CASCADE,
  CONSTRAINT `iscrizioni_ibfk_2` FOREIGN KEY (`codice_biblioteca`) REFERENCES `biblioteche` (`codice`) ON DELETE CASCADE
...
INSERT INTO `iscrizioni` VALUES (1,1),(4,1),(1,2),(2,2),(5,2),(3,3),(5,3);
